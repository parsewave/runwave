...
Screenshots include a 24x24 red mark grid by default. Each cell is labeled with
a number in the center, starting at 0 in the top-left and increasing row-major
to 575 in the bottom-right. Pointer actions may use these numbered cells instead
