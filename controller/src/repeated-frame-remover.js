...
function printUsage() {
  console.error('Usage: node controller/bin/remove-repeated-frames.js <input-video> <output-video> [--edge-frames 10] [--similarity-threshold 0.98] [--pixel-tolerance 3] [--comparison-width 160]');
}
